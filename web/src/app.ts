...
import { EdgeDetector, ProcessingMode } from './edge-detector.js';

class EdgeDetectionApp {
    private camera: CameraSimulator;
    ...
    private setMode(mode: number): void {
        ...
        this.detector.setMode(mode as ProcessingMode);
        const modeText = this.detector.getModeString();
        document.getElementById('mode')!.textContent = `${modeText} Mode`;
